...
public class SeatPrizeTableNumberComboBox extends JComboBox implements ItemListener {
	private static final long serialVersionUID = 1L;

	private LuckyDrawUI2014 parent;

	public SeatPrizeTableNumberComboBox(LuckyDrawUI2014 parent) {
